# setup Hadoop Bin path:
    - Spark can run in “local mode” without Hadoop. It’ll use your local filesystem (file:///) for reads/writes.
...
# When running Spark on a newer JDK (17/21).
    - Spark (or one of its deps) is still trying to use internal sun.* classes.
        With the Java module system, those internals are blocked unless you explicitly open/export them.
